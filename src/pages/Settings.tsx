...
const Settings = () => {
  ...
  return (
    <div className="px-6 py-8 lg:px-10 max-w-3xl">
      ...
      <h1 className="mt-4 text-2xl font-extrabold lg:text-3xl">{t("settings.title")}</h1>
      <p className="mt-1 text-sm text-muted-foreground">{t("settings.subtitle")}</p>

      {/* Simulation */}
      <h2 className="mt-8 text-xs font-bold uppercase tracking-widest text-muted-foreground">{t("settings.simulation")}</h2>
          ...
          <div className="flex items-center justify-between px-5 py-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">{t("settings.voiceInputDesc")}</p>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between px-5 py-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">{t("settings.showHintsDesc")}</p>
              </div>
            </div>
      ...
      {/* Appearance */}
      <h2 className="mt-8 text-xs font-bold uppercase tracking-widest text-muted-foreground">{t("settings.appearance")}</h2>
      <Card className="mt-3 shadow-soft border-border overflow-hidden">
        <CardContent className="divide-y divide-border p-0">
          <div className="flex items-center justify-between px-5 py-4">
            <div className="flex items-center gap-4">
          ...
          <div>
            ...
            {showLangPicker && (
              <div className="border-t border-border px-5 py-2 animate-fade-in">
                {languages.map((lang) => (
                  <button
                    key={lang.code}
                    onClick={() => {
                    ...
                    className={`flex w-full items-center justify-between rounded-xl px-4 py-3 text-sm font-medium transition-colors tap-scale ${
      ...
      {/* Notifications */}
      <h2 className="mt-8 text-xs font-bold uppercase tracking-widest text-muted-foreground">{t("settings.notifications")}</h2>
      <Card className="mt-3 shadow-soft border-border overflow-hidden">
      ...
      {/* Account */}
      <h2 className="mt-8 text-xs font-bold uppercase tracking-widest text-muted-foreground">{t("settings.account")}</h2>
      <Card className="mt-3 shadow-soft border-border overflow-hidden">
        <CardContent className="divide-y divide-border p-0">
