    ...
    <div className="px-6 py-8 lg:px-10 max-w-5xl">
      <div className="flex items-end justify-between">
        <div>
          ...
          <h1 className="text-2xl font-extrabold lg:text-3xl">{t("explore.title")}</h1>
        </div>
      ...
      <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 pb-6">
        ...
        {filtered.length === 0 && (
          <div className="col-span-full flex flex-col items-center py-20">
            ...
            <p className="mt-3 text-lg font-semibold text-foreground">{t("explore.noResults")}</p>
            <p className="text-sm text-muted-foreground">{t("explore.adjustFilters")}</p>
          </div>
        )}
      </div>
    </div>
